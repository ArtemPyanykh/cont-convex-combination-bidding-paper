...
\textbf{TODO:}
\begin{enumerate}
\item Подставить $h$ в $G$ выше, получить формулу для нижней оценки,
\item Показать, что $h$ - является неубывающей из $[0, 1]$ в $[0, 1]$,
\item Показать, что в общем случая нижняя оценка также имеет место; для этого придется сформулировать еще одну лемму о свойствах функции $h$.
\end{enumerate}
