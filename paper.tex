...
В [\ref{lit:demeyer02}] показано, что игра $G_{n+1}(P)$ имеет рекурсивную структуру в том смысле, что задачу о нахождении выигрыша в $(n+1)$-шаговой игре можно свести в задаче о нахождении выигрыша в $n$-шаговой игре следующим образом.
...
Приведем несколько фактов, которые понадобятся нам в дальнейшем. Доказательства см. [\ref{lit:demeyer02}].
...
\begin{lemma}
  ...
  \end{equation}
\end{lemma}
Подчеркнем, что посколько можно положить $V_0(P) = 0$, данная формула имеет смысл для любого $n \geqslant 1$.
...
Аналогично предыдущему пункту, можно провести рассмотрение рекурсивной структуры игры $G^*_n(x)$ и получить следующий результат [\ref{lit:demeyer02}].
