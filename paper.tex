...
\subsection{Оценка на $\mathbf{V_{1,n}\left(P\right)}$}\label{sec:-regular-game-estimate}
...
\subsection{Оценка на $\mathbf{W_{2,n}\left(x\right)}$}\label{sec:-dual-game-estimate}
