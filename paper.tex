...
\newcommandx*\dg[4][1=n, 2={\dualFPS}, 3=x, 4=\tau]{\ensuremath{g^*_{#1}(#3, #2, #4)}}
...
\begin{equation*}
  \dg = x P - g_n(P, \sigma, \tau),
\end{equation*}
а верхнее и нижнее значения игры даются, соответственно, формулами
\begin{equation*}
  W_{1,n}(x) = \inf_{\dualFPS} \sup_\tau \dg, \quad
  W_{2,n}(x) = \sup_\tau \inf_{\dualFPS} \dg.
\end{equation*}
