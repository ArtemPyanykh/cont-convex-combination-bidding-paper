...
Тогда для функций в $\mathbb{R}$ имет место следующее включение (см. [\ref{lit:rockafellar}, \S 24]):
...
\begin{proof}
  ...
  Пусть $p_2 < f(0)$.
  Тогда из \eqref{eq:F:pBased} получаем, что справделиво следующее неравенство
  \begin{multline*}
    \F{p_2} = \int_0^1 \left[
      Q(u) - \Co f(u) - \Dco p_2
      \right] \di u \; + \\
...
\begin{proof}
  ...
  \]
  Пробразовав \eqref{eq:W:lowerBound:parameterized}, получим что
