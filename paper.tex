...
Во-вторых, связь между эффективным множеством функции и образом субдифференкциала сопряженной функции.
...
\textbf{TODO: добавить сюда некоторый вывод, просто констатации факта маловато}.
